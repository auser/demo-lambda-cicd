...
Let's get a [Personal Access Token from Github](https://github.com/settings/tokens)

(private repo access and webhooks)

---

```bash
aws --profile demo-deployer secretsmanager \
        create-secret --name demo-cicd-github-token \
...
<CodeSurfer
  ...
  code={require("!raw-loader!../time/deployment/lib/deployment-stack.ts")}
  lang="markdown"
  showNumbers={false}
  theme={nightOwl}
  steps={[
    { notes: "file: ../time/deployment/lib/deployment-stack.ts" },
